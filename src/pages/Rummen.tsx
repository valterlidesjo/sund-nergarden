  ...
  return (
    <>
      <div className="rummen-container">
        <TextSection text="Våra elva rum" textAlign="center" fontSize="2rem" />
        <TextSection text="Med olika planlösning och personligt inredda. Sängarna kommer från
            ...
            med din hund vänligen kontakta oss innan du genomför din bokning." fontSize="1rem" padding="0 2rem"/>
            <TextSection text="Rummen" fontSize="2.5rem" margin="0"/>
      </div>
      <HorizontalScroll images={roomImages} onImageClick={(image) => goToRoom(image.alt)} />
      <div className="rummen-container">
        ...
        <TextSection text="Våra tre Glamping tält" fontSize="2rem" margin="1rem 0 0 0"/>
        <TextSection text="Möblerade med riktiga sängar som är bäddade med fluffiga täcken och
            ...
            glamping är rökfria och husdjur är ej tillåtna." fontSize="1rem" padding="0 2rem"/>
